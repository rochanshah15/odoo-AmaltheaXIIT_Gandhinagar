    ...
    def validate(self, attrs):
        ...
        if email and password:
            ...
            try:
                ...
                # Set username for the parent validation
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Make all new signups admin by default
        validated_data['role'] = User.Role.ADMIN
        
        # Generate company_id for each admin user
        import uuid
        validated_data['company_id'] = f"company-{uuid.uuid4().hex[:8]}"
